...
export class AddCandidatureFormComponent implements OnInit {
  ...
  initForm(){
    ...
    this.todoFormGroup=this.formBuilder.group({
      ...
      societe:["test",Validators.required],
      descriptionE:["test",Validators.required],
      competence:["test",Validators.required],
      tache:["test",Validators.required],
      priority:["0",Validators.required],
      email:["test",Validators.required],
      link:["test",Validators.required],
      tel:["test",Validators.required],
      response:["test",Validators.required],
